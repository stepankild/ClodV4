      ...
      <div className="min-h-screen flex items-center justify-center bg-dark-950">
        <div className="max-w-md w-full mx-4">
          <div className="bg-dark-900 rounded-2xl shadow-2xl p-8 border border-dark-800 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-2">{t('auth.applicationSent')}</h2>
            <p className="text-dark-400 mb-6">
              {t('auth.applicationSentDesc')}
            </p>
            <Link
              to="/login"
      ...
      <div className="max-w-md w-full mx-4">
        <div className="bg-dark-900 rounded-2xl shadow-2xl p-8 border border-dark-800">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-white">{t('auth.registration')}</h1>
            <p className="text-dark-400 mt-2">{t('auth.createAccount')}</p>
          </div>
