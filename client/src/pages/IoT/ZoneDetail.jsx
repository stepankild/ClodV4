                  ...
                  <div className="space-y-1.5 text-xs text-dark-400">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        алерт приходит только когда все три условия выполнены одновременно:
                        (1) датчик возвращает абсолютно идентичные значения <b>≥3 часа</b> подряд,
                        (2) другие датчики в этой зоне в это же время <b>меняются</b>
                        (если застыло всё — это проблема связи/Pi, а не отдельного датчика),
                        (3) для датчика света — значение выше <b>50 lux</b> (темнота ночью это нормально).
                        Zigbee-пропагаторы исключены (они event-based).
                        Кулдаун 6 часов между повторами.
                      </div>
                    </div>
                    <div className="flex items-start gap-2">
