const STRAIN_COLORS = [
  ...
  { bg: 'bg-purple-500/20', border: 'border-purple-500', text: 'text-purple-400', dot: 'bg-purple-500' },
  ...
  { bg: 'bg-rose-500/20', border: 'border-rose-500', text: 'text-rose-400', dot: 'bg-rose-500' },
  { bg: 'bg-lime-500/20', border: 'border-lime-500', text: 'text-lime-400', dot: 'bg-lime-500' },
  { bg: 'bg-indigo-500/20', border: 'border-indigo-500', text: 'text-indigo-400', dot: 'bg-indigo-500' },
